...
//     print(result);
//   });
    //asyncStreamFunc1(5).listen( (value) => print(value) );

    asyncStreamFunc1(5).asyncMap( (value) => print(value));
...
Future<String> asyncFunc2() async {
  return "async return22222222222";
}

Stream<String> asyncStreamFunc1(int x) async* {
  for (int i = 0; i < x; i++) {
